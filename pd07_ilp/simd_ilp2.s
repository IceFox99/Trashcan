...
.LBB0_5:                                # =>This Loop Header: Depth=1
	...
	shlq	$7, %rax
	leaq	(%rax,%rsi,8), %r13
	movl	128(%r14,%r13), %edx
	movl	132(%r14,%r13), %ecx
	vmovsd	(%r14,%r13), %xmm0              # xmm0 = mem[0],zero
	leaq	.L.str(%rip), %rdi
	movq	%rsi, 16(%rsp)                  # 8-byte Spill
	movb	$1, %al
	callq	printf@PLT
	vmovsd	8(%r14,%r13), %xmm0             # xmm0 = mem[0],zero
	leaq	.L.str.1(%rip), %rbp
	movq	%rbp, %rdi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	16(%r14,%r13), %xmm0            # xmm0 = mem[0],zero
	movq	%rbp, %rdi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	24(%r14,%r13), %xmm0            # xmm0 = mem[0],zero
	movq	%rbp, %rdi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	32(%r14,%r13), %xmm0            # xmm0 = mem[0],zero
	movq	%rbp, %rdi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	40(%r14,%r13), %xmm0            # xmm0 = mem[0],zero
	movq	%rbp, %rdi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	48(%r14,%r13), %xmm0            # xmm0 = mem[0],zero
	movq	%rbp, %rdi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	56(%r14,%r13), %xmm0            # xmm0 = mem[0],zero
	movq	%rbp, %rdi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	64(%r14,%r13), %xmm0            # xmm0 = mem[0],zero
	movq	%rbp, %rdi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	72(%r14,%r13), %xmm0            # xmm0 = mem[0],zero
	movq	%rbp, %rdi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	80(%r14,%r13), %xmm0            # xmm0 = mem[0],zero
	movq	%rbp, %rdi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	88(%r14,%r13), %xmm0            # xmm0 = mem[0],zero
	movq	%rbp, %rdi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	96(%r14,%r13), %xmm0            # xmm0 = mem[0],zero
	movq	%rbp, %rdi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	104(%r14,%r13), %xmm0           # xmm0 = mem[0],zero
	movq	%rbp, %rdi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	112(%r14,%r13), %xmm0           # xmm0 = mem[0],zero
	movq	%rbp, %rdi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	120(%r14,%r13), %xmm0           # xmm0 = mem[0],zero
	movq	%rbp, %rdi
	movb	$1, %al
	callq	printf@PLT
	xorl	%ebp, %ebp
...
.LBB0_3:                                # =>This Inner Loop Header: Depth=1
	movl	-4(%r14), %edx
	movl	(%r14), %ecx
	vmovsd	-132(%r14), %xmm0               # xmm0 = mem[0],zero
	movq	%r15, %rdi
	movq	%rbx, %rsi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	-124(%r14), %xmm0               # xmm0 = mem[0],zero
	movq	%r12, %rdi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	-116(%r14), %xmm0               # xmm0 = mem[0],zero
	movq	%r12, %rdi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	-108(%r14), %xmm0               # xmm0 = mem[0],zero
	movq	%r12, %rdi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	-100(%r14), %xmm0               # xmm0 = mem[0],zero
	movq	%r12, %rdi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	-92(%r14), %xmm0                # xmm0 = mem[0],zero
	movq	%r12, %rdi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	-84(%r14), %xmm0                # xmm0 = mem[0],zero
	movq	%r12, %rdi
	movb	$1, %al
	callq	printf@PLT
	vmovsd	-76(%r14), %xmm0                # xmm0 = mem[0],zero
	movq	%r12, %rdi
	movb	$1, %al
	callq	printf@PLT
...
# %bb.0:
	...
	vpslld	$4, %xmm0, %xmm0
	vpor	.LCPI4_0(%rip), %xmm0, %xmm2
	vcvtdq2pd	%xmm2, %ymm2
	movslq	%eax, %rbp
	vmovapd	.LCPI4_1(%rip), %zmm3           # zmm3 = <8,0,1,2,3,u,u,u>
	vpermi2pd	%zmm1, %zmm2, %zmm3
	leal	5(%rcx), %eax
	vcvtsi2sd	%eax, %xmm4, %xmm1
	movb	$32, %al
	kmovw	%eax, %k1
	vbroadcastsd	%xmm1, %zmm3 {%k1}
	leal	6(%rcx), %eax
	vcvtsi2sd	%eax, %xmm4, %xmm1
	movb	$64, %al
	kmovw	%eax, %k1
	...
	movb	$-128, %al
	kmovw	%eax, %k1
	vorpd	.LCPI4_2(%rip), %xmm0, %xmm2
	vorpd	.LCPI4_3(%rip), %xmm0, %xmm0
	vbroadcastsd	%xmm1, %zmm3 {%k1}
	vmovupd	%zmm3, 96(%rsp)                 # 64-byte Spill
	vinsertf128	$1, %xmm0, %ymm2, %ymm0
	vcvtdq2pd	%ymm0, %zmm0
	vmovupd	%zmm0, 32(%rsp)                 # 64-byte Spill
	vzeroupper
	callq	sched_getcpu@PLT
	movq	%rbp, %rcx
	shlq	$7, %rcx
	leaq	(%rcx,%rbp,8), %r13
	movl	%eax, 128(%r14,%r13)
...
# %bb.5:
	...
	andq	$-8, %r15
	xorl	%esi, %esi
	vmovupd	96(%rsp), %zmm2                 # 64-byte Reload
	vmovupd	32(%rsp), %zmm3                 # 64-byte Reload
	jmp	.LBB4_6
	.p2align	4, 0x90
...
.LBB4_8:                                #   Parent Loop BB4_6 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vfmadd213pd	%zmm1, %zmm0, %zmm2     # zmm2 = (zmm0 * zmm2) + zmm1
...
.LBB4_4:                                # =>This Inner Loop Header: Depth=1
	...
	jne	.LBB4_4
.LBB4_13:
	vmovupd	%zmm3, 32(%rsp)                 # 64-byte Spill
