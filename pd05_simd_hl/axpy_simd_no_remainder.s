	.text
	.file	"axpy_simd_no_remainder.c"
	.globl	axpb_simd_no_remainder          # -- Begin function axpb_simd_no_remainder
	.p2align	4, 0x90
	.type	axpb_simd_no_remainder,@function
axpb_simd_no_remainder:                 # @axpb_simd_no_remainder
	.cfi_startproc
# %bb.0:
	#APP
	# ========== loop begins ==========
...
.LBB0_11:
	...
	retq
.Lfunc_end0:
	.size	axpb_simd_no_remainder, .Lfunc_end0-axpb_simd_no_remainder
	.cfi_endproc
                                        # -- End function
